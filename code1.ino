...
void handle_OnConnect() {
  ...
  LED2status = LOW;
  LED3status = LOW;
  Serial.println("GPIO7 Status: OFF | GPIO6 Status: OFF | GPIO0 Status: OFF");
...
String SendHTML(uint8_t led1stat,uint8_t led2stat,uint8_t led3stat){
  ...
  ptr +="body{margin-top: 50px; background-color: #000000;} h1 {color: #444444;margin: 50px auto 30px;} h3 {color: #444444;margin-bottom: 50px;}\n";
  ptr +=".button {display: block;width: 80px;background-color: #1abc9c;border: none;color: white;padding: 13px 30px;text-decoration: none;font-size: 25px;margin: 0px auto 35px;cursor: pointer;border-radius: 4px;}\n";
  ptr +=".button-on {background-color: #FF0000;}\n";
  ptr +=".button-on:active {background-color: #FF0000;}\n";
  ptr +=".button-off {background-color: #7F1616;}\n";
  ptr +=".button-off:active {background-color: #7F1616;}\n";
